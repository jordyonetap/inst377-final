...
**This [web app](https://inst377-final-amoz.vercel.app) allows you to write a brief review on an album and store it in a database. It asks for the artist, album, genre, score 1-10, and a brief description as to why. It displays previously created reviews, the artwork of each album reviewed, and the average score of albums across genre.**
